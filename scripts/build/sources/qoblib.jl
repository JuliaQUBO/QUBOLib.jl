...
const QOBLIB_CONSTRAINED_CLASS_INVENTORY = Dict{String,Any}[
    Dict{String,Any}(
        ...
        "metrics_qs_files_status"      => "metadata_only_no_published_qs_artifacts",
        "solution_paths"               => ["03-birkhoff/solutions"],
        "solution_status"              => "available",
        "submission_status"            => "available",
...
const QOBLIB_DATA = Dict{String,Any}(
    ...
    "metadata"     => Dict{String,Any}(
        ...
        "citation_doi"         => "10.1038/s43588-026-00991-1",
        "license_evidence_url" => "https://github.com/$(QOBLIB_REPOSITORY)/blob/$(QOBLIB_SOURCE_COMMIT)/LICENSE.data",

...
const QOBLIB_CONSTRAINED_INVENTORY_SOURCE = Dict{String,Any}(
    ...
    "canonical_policy"      =>
        "canonical_qoblib_ingests_authoritative_qoblib_qs_or_qubo_artifacts_only",
)

const QOBLIB_CONSTRAINED_CLASS_INVENTORY = Dict{String,Any}[
    Dict{String,Any}(
        "code"                         => "birkhoff",
        "problem_class"                => "Birkhoff Polytope",
        "upstream_path"                => "03-birkhoff",
        "source_model_paths"           =>
            ["03-birkhoff/models/integer_linear/lp_files"],
        "source_model_count"           => 80,
        "source_model_format"          => "LP",
        "source_data_path"             => "03-birkhoff/instances",
        "source_data_blob_count"       => 29,
        "metrics_paths"                => [
            "03-birkhoff/models/integer_linear/lp_files/metrics.csv",
            "03-birkhoff/models/integer_linear/metrics_qs_files.csv",
        ],
        "solution_paths"               => ["03-birkhoff/solutions"],
        "solution_blob_count"          => 9,
        "submission_blob_count"        => 987,
        "authoritative_qubo_artifact"  => false,
        "qs_artifact_count"            => 0,
        "canonical_ingestion_status"   => "unavailable",
        "generated_variant_status"     => "deferred_to_toqubo",
    ),
    Dict{String,Any}(
        "code"                         => "steiner",
        "problem_class"                => "Steiner Tree",
        "upstream_path"                => "04-steiner",
        "source_model_paths"           =>
            ["04-steiner/models/integer_linear/lp_files"],
        "source_model_count"           => 72,
        "source_model_format"          => "LP",
        "source_data_path"             => "04-steiner/instances",
        "source_data_blob_count"       => 1331,
        "metrics_paths"                => [
            "04-steiner/models/integer_linear/lp_files/metrics.csv",
            "04-steiner/models/integer_linear/metrics_qs_files.csv",
        ],
        "solution_paths"               => ["04-steiner/solutions"],
        "solution_blob_count"          => 44,
        "submission_blob_count"        => 0,
        "authoritative_qubo_artifact"  => false,
        "qs_artifact_count"            => 0,
        "canonical_ingestion_status"   => "unavailable",
        "generated_variant_status"     => "deferred_to_toqubo",
    ...
    Dict{String,Any}(
        "code"                         => "sports",
        "problem_class"                => "Sports Timetabling",
        "upstream_path"                => "05-sports",
        "source_model_paths"           =>
            ["05-sports/models/mixed_integer_linear/lp_files"],
        "source_model_count"           => 249,
        "source_model_format"          => "LP",
        "source_data_path"             => "05-sports/instances",
        "source_data_blob_count"       => 250,
        "metrics_paths"                => [
            "05-sports/models/mixed_integer_linear/lp_files/metrics.csv",
            "05-sports/models/mixed_integer_linear/metrics_qs_files.csv",
        ],
        "solution_paths"               => ["05-sports/solutions"],
        "solution_blob_count"          => 401,
        "submission_blob_count"        => 1,
        "authoritative_qubo_artifact"  => false,
        "qs_artifact_count"            => 0,
        "canonical_ingestion_status"   => "unavailable",
        "generated_variant_status"     => "deferred_to_toqubo",
    ...
    Dict{String,Any}(
        "code"                         => "network",
        "problem_class"                => "Network Design",
        "upstream_path"                => "08-network",
        "source_model_paths"           => ["08-network/models/integer_lp/lp_files"],
        "source_model_count"           => 20,
        "source_model_format"          => "LP",
        "source_data_path"             => "08-network/instances",
        "source_data_blob_count"       => 2,
        "metrics_paths"                => [
            "08-network/models/integer_lp/lp_files/metrics.csv",
            "08-network/models/integer_lp/metrics_qs_files.csv",
        ],
        "solution_paths"               => ["08-network/solutions"],
        "solution_blob_count"          => 22,
        "submission_blob_count"        => 81,
        "authoritative_qubo_artifact"  => false,
        "qs_artifact_count"            => 0,
        "canonical_ingestion_status"   => "unavailable",
        "generated_variant_status"     => "deferred_to_toqubo",
    ...
    Dict{String,Any}(
        "code"                         => "routing",
        "problem_class"                => "Capacitated Vehicle Routing",
        "upstream_path"                => "09-routing",
        "source_model_paths"           => ["09-routing/models/integer_linear/lp_files"],
        "source_model_count"           => 55,
        "source_model_format"          => "LP",
        "source_data_path"             => "09-routing/instances",
        "source_data_blob_count"       => 56,
        "metrics_paths"                => [
            "09-routing/models/integer_linear/lp_files/metrics.csv",
            "09-routing/models/integer_linear/metrics_qs_files.csv",
        ],
        "solution_paths"               => ["09-routing/solutions"],
        "solution_blob_count"          => 56,
        "submission_blob_count"        => 0,
        "authoritative_qubo_artifact"  => false,
        "qs_artifact_count"            => 0,
        "canonical_ingestion_status"   => "unavailable",
    ...
    Dict{String,Any}(
        "code"                         => "topology",
        "problem_class"                => "Graph Topology Design",
        "upstream_path"                => "10-topology",
        "source_model_paths"           => [
            "10-topology/models/flow_mip/lp_files",
            "10-topology/models/seidel_linear/lp_files",
            "10-topology/models/seidel_quadratic/lp_files",
        ],
        "source_model_count"           => 48,
        "source_model_format"          => "LP",
        "source_data_path"             => "10-topology/instances",
        "source_data_blob_count"       => 28,
        "metrics_paths"                => [
            "10-topology/instances/bounds.csv",
            "10-topology/models/flow_mip/lp_files/metrics.csv",
            "10-topology/models/flow_mip/metrics_qs_files.csv",
            "10-topology/models/seidel_linear/lp_files/metrics.csv",
            "10-topology/models/seidel_linear/metrics_qs_files.csv",
            "10-topology/models/seidel_quadratic/lp_files/metrics.csv",
        ],
        "solution_paths"               => ["10-topology/solutions"],
        "solution_blob_count"          => 27,
        "submission_blob_count"        => 194,
        "authoritative_qubo_artifact"  => false,
        "qs_artifact_count"            => 0,
        "canonical_ingestion_status"   => "unavailable",
        "generated_variant_status"     => "deferred_to_toqubo",
...
const QOBLIB_DATA = Dict{String,Any}(
    ...
    "metadata"     => Dict{String,Any}(
        ...
        "arxiv"         => "2504.03832",
        "constrained_class_inventory_source" => QOBLIB_CONSTRAINED_INVENTORY_SOURCE,
        "constrained_class_inventory"        => QOBLIB_CONSTRAINED_CLASS_INVENTORY,
    ),
)
